...
class DataGenerator:
    ...
    def generate_death_cross_scenario(self) -> List[Dict[str, object]]:
        events = []
        ...
        for i in range(60):
            ...
            event = {
                ...
                "price_change_24h": round(
                    (price - self.base_price) / self.base_price * 100, 2
                ),
                "source": "coingecko",
            }
            events.append(event)
    ...
    def generate_volume_spike_scenario(self) -> List[Dict[str, object]]:
        events = []
        start_time = datetime.now()
